...
(function () {
  ...
  function initSealPicker() {
    ...
    var STYLES = [
      ...
      { id: 'notch-thick', name: 'Cut corner · bold rim', note: 'Same shape, heavier gold rim' },
      { id: 'notch-double', name: 'Cut corner · double rim', note: 'Gold rim with a second inner line' },
      { id: 'notch-red', name: 'Cut corner · red rim', note: 'Red rim, gold year' },
      { id: 'notch-gold', name: 'Cut corner · gold fill', note: 'Gold slab, navy words' },
      { id: 'notch-wide', name: 'Cut corner · deep cuts', note: 'Larger corner cuts, gold rim' },
      { id: 'notch-glass', name: 'Cut corner · glass', note: 'See-through fill inside the gold rim' }
    ];
